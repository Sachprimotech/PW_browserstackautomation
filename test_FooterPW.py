...
class Testone(BaseClass):
    def test_menubar(self):
        ...
        if window_size['width']>980:
            popup=self.driver.find_element(By.XPATH,"//div[@id='normal-slidedown']/div[2]/button[2]")
            popup.click()
            ...
            Footer_css=self.driver.find_element(By.CSS_SELECTOR,"#ft-first-row.et_pb_row")
            ...
            for mecss in ftu_links:
               if mecss != None:
                  mfd=['font-size','font-weight','font-family','color','letter-spacing']
                  for me in mfd:
            ...
            assert set(footer_linksvalues)==set(all_windowslinks) or len(footer_linksvalues)==14
