...
class Testone(BaseClass):
    def test_HomePageFeatured(self):
        ...
        if window_size['width']> 980:
            ...
            left_section=self.driver.find_elements(By.CSS_SELECTOR,"#mainFeatured div#leftFeaturedblog")
            ...
            assert set(left_section_css) == imagesection_set or len(set(left_section_css))==3

            right_section=self.driver.find_elements(By.CSS_SELECTOR,"#mainFeatured #featureBlogsection")
