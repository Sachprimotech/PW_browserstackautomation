...
class Testone(BaseClass):
    def test_header(self):
        ...
        if window_size['width']> 767:
          ...
          social_lnk=self.driver.find_elements(By.XPATH,"//div[@class='social-box']/ul/li/a")
          ...
          subscribe= self.driver.find_element(By.XPATH,"//div[@id='header-row-cstm']/div[3]/div")
          assert subscribe.is_displayed
          social_lnkcss=self.driver.find_elements(By.XPATH,"//div[@class='social-box']/ul/li")
          ...
          css=print(Cssvalue)
          log.info(css)   
          assert Cssvalue ==['14px', '400', 'Elza', 'rgba(0, 0, 0, 0.5)', '23.8px', '14px', '400', 'elza', 'rgba(148, 148, 148, 1)', '23.8px'] or len(set(Cssvalue))==7
