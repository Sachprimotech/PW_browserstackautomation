...
class Testone(BaseClass):
    def test_HomePage(self):
        ...
        if window_size['width']> 767:
            ...
            Tittles=self.driver.find_elements(By.CSS_SELECTOR,"#et-boc .homepage-section-hdng")
...
# Compare fetched CSS properties with the expected set
            ...
            Article_tittle=self.driver.find_elements(By.CSS_SELECTOR,"#et-boc .homepage-section-hdng h3")
            for Article in Article_tittle:
               ar=['font-size','font-family','font-weight','line-height','text-transform','padding-bottom','color']
               for a in ar:
                article_tittleCss.append(Article.value_of_css_property(a))
           
            articltittle_set={'28px','Elza','600','100%','uppercase','15px'}   

            assert set(article_tittleCss) ==  articltittle_set or len(set(article_tittleCss))==5