...
class Testone(BaseClass):
    def test_HomePageFeatured(self):
        ...
        if window_size['width']> 980:
            ...
            ("#doctorVoicesection div#doctorVoiceFeatureblog", {'3%','55%','1px solid #bfbfbf','40px'} , ['margin-right', 'width', 'border-right','padding-right']),
            (".post-categories", {'5px', 'uppercase', '#0179d9','18px','600','14px','Elza'}, ['margin-bottom', 'text-transform', 'color','line-height','font-weight','font-size','font-family']),
            ("#doctorVoicesection div#doctorVoiceFeatureblog .featuredDoctorpost article .post-media",{'100%','100%'},['height','width']),("#doctorVoicesection div#doctorVioceblogsec article a img",{'cover','183px','100%'},['object-fit','height']),
            ("#doctorVoicesection div#doctorVioceblogsec article a img",{'cover','height','100%'},['object-fit','height','max-width']),
            ("#doctorVoicesection div#doctorVioceblogsec article .post-content h2.entry-title a",{'none','#152c6c','30px','600','24px','Elza'},['text-transform','color','line-height','font-weight','font-size','font-family']),
         ]
            ...
            selectors_and_properties = [
            ("#doctorVoicesection div#doctorVoiceFeatureblog", {'3%','55%','1px solid #bfbfbf','40px'} , ['margin-right', 'width', 'border-right','padding-right']),
            (".post-categories", {'uppercase','left','.025em','17px','700','14px','Elza','rgba(1, 121, 217, 1)'} , ['text-transform','text-align','letter-spacing','line-height','font-weight','font-size','font-family','color']),
            ("#doctorVoicesection div#doctorVioceblogsec article a img",{'cover','height','100%'},['object-fit','height','max-width']),
            ("#doctorVoicesection div#doctorVioceblogsec article .post-content h2.entry-title a",{'none','#152c6c','30px','600','24px','Elza'},['text-transform','color','line-height','font-weight','font-size','font-family']),
         ]
